...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      {find: '@bedrock/web-session', replacement: mock('bedrock/web-session.js')},
      {find: '@bedrock/web-account', replacement: mock('bedrock/web-account.js')},
      {find: '@bedrock/web-authn-token', replacement: mock('bedrock/web-authn-token.js')},
