...
const vcViewConfigurations = [
  ...
  {
    matches: {
      '/@context': `https://w3c-ccg.github.io/vc-ed/plugfest-1-2022/
        jff-vc-edu-plugfest-1-context.json`,
      '/type': 'OpenBadgeCredential'
    },
    styles: {
  ...
  {
    matches: {
      '/@context': `https://contexts.vcplayground.org/examples/
        food-safety-certification/v1.json`,
  ...
  },
  {
    matches: {
      '/@context':
        'https://contexts.vcplayground.org/examples/movie-ticket/v1.json',
...
// expose as `vcViewConfigurations` on shared web app config
config.vueWallet.vcViewConfigurations = vcViewConfigurations;
