...
// the render-method resolution every credential surface needs. Exported here
// because `package.json` maps `.` to this file and declares no `./lib/`, so a
// downstream wallet could not otherwise reach it and would fork the logic --
// the duplication extracting it set out to remove.
export {getCredentialSummary} from './credentialSummary.js';
export {getRenderedDisplays} from './renderMethod.js';
