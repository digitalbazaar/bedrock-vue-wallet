...
/**
 * Adds a configuration to bedrock-vue-wallet's `config`. This call will
 * layer the given config on top of `config`, overwriting any matching keys.
 * This should be called before calling `initialize` or using the `config`
