...
// Module state outlives a test. Without a reset, a mount that never reaches
// `render()` silently drives the previous test's handle, and an assertion
// about teardown passes against an already-destroyed stale one.
export function resetLastHandle() {
  lastHandle = null;
}
